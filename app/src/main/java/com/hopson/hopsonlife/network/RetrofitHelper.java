package com.hopson.hopsonlife.network;


import com.hopson.hopsonlife.base.HopsonStewardApp;
import com.hopson.hopsonlife.network.auxiliary.ApiConstants;
    ...
    private static void initOkHttpClient() {
        ...
        if (mOkHttpClient == null) {
            synchronized (RetrofitHelper.class) {
                if (mOkHttpClient == null) {
                    //设置Http缓存
                    Cache cache = new Cache(new File(HopsonStewardApp.getInstance().getCacheDir(), "HttpCache"), 1024 * 1024 * 10);
